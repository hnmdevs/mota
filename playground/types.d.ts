/**
 * Automatically generated types for mota
 * Do NOT edit this file manually.
 * 
 * Consider adding this file to .prettierignore and eslint ignore.
 */
import { EventHandler, ApiRouteHandler, ApiResponse, MotaStream, CronHandler } from 'mota'

declare module 'mota' {
  interface FlowContextStateStreams {
    'message': MotaStream<{ message: string; from: 'user' | 'assistant'; status: 'created' | 'pending' | 'completed' }>
    'message_python': MotaStream<{ message: string }>
  }
