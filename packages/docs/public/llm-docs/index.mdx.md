...
<div className="my-8">![Mota Workbench Interface](./img/workbench-presentation.png)</div>
...
3.  **Dive into Concepts:** Delve deeper into Mota's [Core Concepts](/docs/getting-started/core-concepts) to gain a solid understanding of the framework's architecture and principles.
