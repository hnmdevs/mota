---
title: 'Real-Time Uptime Monitoring: Building a Resilient Website Monitor with Mota'
---
...
This comprehensive guide explores how to build a production-ready uptime monitoring system using Mota's event-driven architecture. We'll cover:

1.  **Event-Driven Monitoring**: How Mota's `steps` create a scalable, maintainable monitoring pipeline.
...
At its core, our uptime monitoring system solves a fundamental challenge: how do you continuously monitor multiple websites without creating a brittle, monolithic application? Traditional monitoring tools often suffer from tight coupling, making them difficult to scale and customize. Our Mota-powered solution breaks this down into discrete, event-driven components that each handle a specific aspect of monitoring.
...
-   **[Mota Framework](https://mota.dev)**: Event-driven orchestration with built-in observability
...
<Tabs items={['cron', 'checker', 'alerter', 'health', 'utilities']}>
    ...
    export const handler = async (input, { logger, emit }) => {
      ...
      try {
        ...
        const response = await fetch(url, {
          ...
          headers: {
            'User-Agent': 'Mota-Uptime-Monitor/1.0',
            'Accept': '*/*',
  ...
  <Tab value="utilities">
    ...
    **Status Storage (`lib/streams.js`)**
    ...
    const STORE_FILE = join(process.cwd(), '.mota', 'status-store.json')
...
The Mota Workbench provides a visual representation of your monitoring pipeline, making it easy to understand the event flow and debug issues in real-time.

<div className="my-8">![Uptime Monitor in Mota Workbench](./../img/uptime-monitor.gif)</div>
...
Start the Mota development server to begin monitoring your websites.
    ...
    <div className="flex items-start space-x-4">
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <a 
            href="https://github.com/MotaDev/mota-examples/tree/main/examples/mota-uptime-monitor" 
            target="_blank" 
...
Ready to build monitoring infrastructure that scales with your business? Start building with Mota today!
